...
| Supply-chain evidence | Native builds, all-severity CVE gate with enforced OpenPGP non-applicability, SBOM, provenance, signing | GitHub Actions must run in user's repo |
